...
def create_run_config(is_training, is_finetune, model_config):
  kwargs = dict(
      ...
      init_range=model_config['init_range'],
      init_std=model_config['init_std'],
      clamp_len=model_config['clamp_len'])

  if not is_finetune:
    kwargs.update(dict(
        mem_len=model_config['mem_len'],
        reuse_len=model_config['reuse_len'],
        bi_data=model_config['bi_data'],
        clamp_len=model_config['clamp_len'],
        same_length=model_config['same_length']))
